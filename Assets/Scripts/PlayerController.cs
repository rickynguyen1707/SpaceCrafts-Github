...
public class PlayerController : MonoBehaviour {
    ...
    void FixedUpdate ()
    {
        ...
        rBody.position = new Vector2(Mathf.Clamp(rBody.position.x, bottomLeftBoundary.x, topRightBoundary.x), Mathf.Clamp(rBody.position.y, bottomLeftBoundary.y, topRightBoundary.y));
	}
}
